...
@Composable
fun CollectionPriceChart(
    prices: List<CollectionPrice>,
    ...
    if (prices.isEmpty()) {
        Card(
            ...
            Box(
                ...
                Text("Нет данных о стоимости коллекции")
            }
        }
        return
    }
    ...
    val minPrice = sortedPrices.minOfOrNull { it.totalValue } ?: 0.0
    val maxPrice = sortedPrices.maxOfOrNull { it.totalValue } ?: 1.0
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "График изменения стоимости коллекции",
                ...
                if (sortedPrices.size > 1) {
                    ...
                    sortedPrices.forEachIndexed { index, price ->
                        ...
                        val normalizedPrice = if (priceRange > 0) {
                            ((price.totalValue - minPrice) / priceRange).toFloat()
                        } else {
                            0.5f
                        }
